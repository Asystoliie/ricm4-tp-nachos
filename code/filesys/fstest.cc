...
void run_test() {
    ...
    test_prompt("mkdir -p this/is/a/simple/test/by/liz/and/salem");
    strcpy(test_args[0], "this/is/a/simple/test/by/liz/and/salem");
    fileSystem->MakeParentDir(test_args[0]);

    test_prompt("cd this/is/../is/../is/././a/simple/test/by/liz/and/salem");
    strcpy(test_args[0], "this/is/../is/../is/././a/../a/simple/test/by/liz/and/salem");
    fileSystem->ChangeDir(test_args[0]);
